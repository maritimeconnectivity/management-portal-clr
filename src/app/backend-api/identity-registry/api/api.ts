...
export * from './secomController.service';
import { SecomControllerService } from './secomController.service';
...
export const APIS = [AgentControllerService, CertificateControllerService, DeviceControllerService, LogoControllerService, MmsControllerService, OrganizationControllerService, RoleControllerService, SecomControllerService, ServiceControllerService, UserControllerService, VesselControllerService, VesselImageControllerService];
